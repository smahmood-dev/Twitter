...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "LBXhtfUSAgKTzWeMkiFbpvhdJ", consumerSecret: "CRYe1zd4QVplNiGBhMDasXokxeZM2aMBLWWOJGIv2P6JbRtgrd")
    var loginSuccess: (() -> ())?
